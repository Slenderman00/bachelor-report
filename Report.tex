...
An illustration of how the Diffie-Hellman key exchange protocol works can be seen in
\textit{Figure \ref{fig:diffie-hellman}}.

\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{diffiehellman.drawio.png}
  \caption{An illustration of the Diffie-Hellman key exchange protocol. \\**The secret number is a discrete logarithm of the common prime this is called a generator.}
