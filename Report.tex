...
Sensor management is an essential part of administrating a larger network. Together with Lightside Instruments we have 
developed open source tools for YANG and NETCONF aimed at sensor management.
