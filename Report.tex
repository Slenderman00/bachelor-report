...
\subsubsection{PRISMA\cite{PRISMAStatement} flow diagram}
...
\begin{figure}
  ...
  \node[sidebox, right=1.5cm of eligibility] (excluded2)
      ...
      - Not focused on methodology (n = E1)\\
      - Not software development (n = E2)\\
      - Conference abstracts only (n = E3)\\
      - Other (n = E4)};
